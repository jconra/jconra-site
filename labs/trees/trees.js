...
function buildDraws() {
  ...
  for (const sp of SPECIES) {
    ...
    mat.uniforms.blendDist.value = SET.blendDist; mat.uniforms.parallax.value = SET.parallax ? 1 : 0;
...
$('parallax').addEventListener('change', e => { SET.parallax = e.target.checked; for (const b of built) b.imposter.material.uniforms.parallax.value = SET.parallax ? 1 : 0; });
